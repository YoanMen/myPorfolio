  ...
  return createPortal(
    <div
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="mx-auto w-fit text-sm font-normal select-none">
          {message}
        </div>
        <button aria-label="bouton fermer" onClick={onHandleClose}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
            height="1em"
      ...
      <div className="w-full h-[2px] bg-stroke mt-4 overflow-hidden rounded">
        <div className="h-full bg-button rounded slider"></div>
      </div>
    </div>,
    document.body
  );
